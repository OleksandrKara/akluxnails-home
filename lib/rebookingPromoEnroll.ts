...
/** Enrolls a customer in the Square auto-discount group for the same-day-rebooking promo, and
 * (server-side, via salaryReview) alerts staff — see openspec/changes/same-day-rebooking-discount
 * design.md D7. Best-effort: never blocks or fails the booking itself. The signature is
 * re-verified again on salaryReview's side independently — this call alone proves nothing on its
 * own, matching design.md D8. */
